...
\begin{lemma}[two witness families]\label{lem:wit-k2}
Let $2\le e<e'$. Then
\[
...
is $(t+1)g$ where $g$ is the gcd of the entries of $Q_{e,e'}$. By Lemma~\ref{lem:wit-k2},
...
Lemma~\ref{lem:wit-k2}, both families & all $2\le e<e'\le8$ & $21/21$, $21/21$\\
