...
$Q_{e,e'}=[R_e,R_{e'}]/(1+t)$ of the previous paper. Theorem~\ref{thm:wit-k3} proves sharpness for
...
\begin{theorem}[uniform witness at $k=3$]\label{thm:wit-k3}
...
return and what Theorem~\ref{thm:wit-k3} predicts for $j=3$.
...
\begin{enumerate}
\item The $r\ge2$ signed counts for $k\ge4$ (Remark after Theorem~\ref{thm:wit-k3}). This would give
